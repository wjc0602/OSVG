...
srun -p ai4earth --gres=gpu:2 --job-name=$DATA_NAME --quotatype=reserved python -m torch.distributed.launch --nproc_per_node=2 --master_port 28363 --use_env eval_osvg.py \
